  ...
  angular.module("mightyDatepicker", []).directive("mightyDatepicker", [
    "$compile", "$timeout", function ($compile, $timeout) {
      ...
      pickerTemplate = "<div class=\"mighty-picker__wrapper\">" +
        ...
        "            <div class=\"mighty-picker-calendar__day-wrapper\">" + "              {{:: day.date.date() }}" + 
        "            </div>" + 
        ...
        "    </table>" + 
        "  </div>" + 
        "  <button type=\"button\" class=\"mighty-picker__next-month\" ng-click=\"moveMonth(1, $event)\">" + 
        "    >>" + 
        "  </button>"+
        "</div>";
      options = {
